...
static const uint16_t gc032a_default_regs[][2] = {
    ...
    /*isp*/
    {0xfe, 0x01},
    {0x0a, 0x45}, // Set to 0x45 in GC code, but 0xc5 is driver default. Needed for enabling manual analog gain.
    {0x45, 0x00},
    {0xfe, 0x00},
    {0x40, 0xff},
    {0x41, 0x25},
    ...
    {0x43, 0x10},
    {0x44, 0x83},
    {0x46, 0x23}, // Set to 0x22 in GC sample, but use 0x23.
    {0x49, 0x03},
    {0x52, 0x02},
    {0x54, 0x00},
    {0xfe, 0x02},
    ...
    /*AEC*/
    {0xfe, 0x00},
    {0x48, 0x03}, // Analog Gain; max 04
    {0x4f, 0x00}, // Disabe AEC.
    {0xfe, 0x01},
    {0x0d, 0x00},
    {0x12, 0xa0},
    {0x13, 0x3a},
